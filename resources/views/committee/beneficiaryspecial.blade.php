        ...
        <div class="container-fluid">
            ...
            <ul class="nav justify-content-center">
                <li class="nav-item px-2">
                    <a class="nav-link border bg-danger text-white" href="{{route('committee.beneficiarydisciplinary',$personalSection['id'])}}">Displinary Section</a>
                </li>
                <li class="nav-item px-2">
                ...
                <li class="nav-item px-2">
                    <a class="nav-link border bg-danger text-white" href="{{route('committee.additionalinfo',$personalSection['id'])}}">Additional Information</a>
                </li>
            ...
            <div class="row justify-content-center">
                <div class="col-10 col-sm-10 col-md-10 col-lg-10 col-xl-10 text-center p-0 mt-3 mb-2">
                    <div class="card px-2 pt-4 pb-0 mt-3 mb-3">
                        <h2 id="heading">Special Scholar Profile</h2>
                        ...
                        <section id="msform">
                                ...
                                <div class="form-card ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="TotalMarks" value="<?php echo $academicSection[0]->TotalMarks ?>" placeholder="Total Marks" disabled />
                                        </div>
                                        @endif
                                ...
                                <div class="form-card">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="SiblingMobile1" value="{{ $itm->SiblingMobile1 }}" placeholder="Sibling Mobile 1" disabled />
                                        </div>
                                        @endforeach
                                        @endif
                            ...
                            <fieldset>
                                ...
                                <div class="form-card">
                                    <div class="row">
                                        <div class="col-7">
                                            <h2 class="fs-title">Action Reason:</h2>
                                        </div>
                                        <div class="col-5">
