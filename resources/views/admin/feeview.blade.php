    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('admin.approvedbeneficiaries')}}">Scholarship List</a></li>
                    <li class="breadcrumb-item"><a href="{{route('admin.beneficiaryfee',$dis->beneficiary_id)}}">Fee Ledger</a></li>
