                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="{{route('admin.downloadsupportingdoc',$fee->id)}}" target="_blank" rel="noopener noreferrer" style="color:unset;text-decoration:none">
                                                        {{$fee->name}}
                                                    </a>
                                                </li>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="{{route('admin.downloadsupportingdoc',$copy->id)}}" target="_blank" rel="noopener noreferrer" style="color:unset;text-decoration:none">
                                                        {{$copy->name}}
                                                    </a>
                                                </li>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="{{route('admin.downloadsupportingdoc',$passport->id)}}" target="_blank" rel="noopener noreferrer" style="color:unset;text-decoration:none">
                                                        {{$passport->name}}
                                                    </a>
                                                </li>
                                                @endforeach
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <form method="POST" action="{{ route('admin.approveapplicant') }}" class="form-input">
                                            ...
                                            <textarea name="applicantactionreason" id="" cols="30" rows="8" placeholder="Approve Reason" value="{{ old('applicantactionreason') }}" required></textarea>
