...
class CommitteeDashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('committee.index', compact('totalApp', 'pendingApp', 'approvedApp', 'expiredApp'));
    }
    /**
     * Display a listing of the resource.
     *
    ...
    public function applicationlist()
    {
        ...
        // dd($data);
        return view('committee.applications', compact('data'));
    }
    ...
    public function approvedbeneficiaries()
    {
        ...
        // dd($data);
        return view('committee.beneficiaries', compact('data'));
    }
    ...
    public function archivedbeneficiaries()
    {
        ...
        // dd($data);
        return view('committee.archivedbeneficiaries', compact('data'));
    }
    public function rejectedapplicants()
    {
        ...
        // dd($data);
        return view('committee.rejectedapplicants', compact('data'));
    }
    ...
    public function selectbeneficiary($id)
    {
        ...
        if (!is_null($personalSectionAux)) {
            ...
            if ($personalSection['Type'] == 'SPECIAL') {
                return view('committee.beneficiaryspecial', compact(['personalSection', 'academicSection', 'familySection', 'statementSection', 'siblingSection', 'emergencySection', 'familyPropertySection', 'reasonSection']));
            } elseif ($personalSection['Type'] == 'THEOLOGY') {
                return view('committee.beneficiarytheology', compact(['personalSection', 'academicSection', 'familySection', 'statementSection', 'siblingSection', 'emergencySection', 'familyPropertySection', 'reasonSection']));
            } else {
                return view('committee.beneficiary', compact(['personalSection', 'academicSection', 'familySection', 'statementSection', 'siblingSection', 'emergencySection', 'familyPropertySection', 'reasonSection']));
            }
        } else {
            return back();
        }
    ...
    public function beneficiarydisciplinary($id)
    {
        ...
        // dd($data);
        return view('committee.beneficiarydiscipline', compact('data', 'id'));
    }
    ...
    public function beneficiaryfee($id)
    {
        ...
        return view('committee.beneficiaryfee', compact('data', 'id', 'personalSection'));
    }
    ...
    public function beneficiarymentorship($id)
    {
        ...
        // dd($data);
        return view('committee.beneficiarymentor', compact('data', 'id'));
    }
    ...
    public function newmentor($id)
    {
        // $data = DB::table('mentorship_sections')->where('beneficiary_id', $id)->get();
        // dd($data);
        return view('committee.mentorform', compact('id'));
    }
    ...
    public function viewmentor($id)
    {
        ...
        return view('committee.mentorview', compact('dis'));
    }
    ...
    public function newdisciplinary($id)
    {
        // $data = DB::table('mentorship_sections')->where('beneficiary_id', $id)->get();
        // dd($data);
        return view('committee.disciplineform', compact('id'));
    }
    ...
    public function viewdisciplinary($id)
    {
        ...
        return view('committee.disciplineview', compact('dis'));
    }
    ...
    public function newfee($id)
    {
        ...
        return view('committee.feeform', compact('id', 'annualFee', 'activeYear'));
    }
    ...
    public function viewfee($id)
    {
        ...
        //    dd($pendingfee);
        return view('committee.feeview', compact('dis', 'yearfee', 'pendingfee'));
    }
    ...
    {
        $usrs = User::all();
        return view('committee.userlist', compact('usrs'));
    }

    public function academicyears()
    {
        $data = AcademicYear::get();
        return view('committee.academicyears', compact('data'));
    }

    public function academicyearview()
    {
        return view('committee.academicyearform');
    }
    ...
    {
        $activeYear = AcademicYear::where('status', true)->first();
        return view('committee.yearlyfeelist', compact('activeYear'));
    }
    ...
    public function createyearlyfees()
    {
        ...
        return view('committee.yearlyfeeform', compact('data'));
    }
    ...
    public function importyearlyfees()
    {
        ...
        return view('committee.importyearlyfeeform', compact('academicYear'));
    }
    ...
    public function schoolreport($id)
    {
        ...
        return view('committee.schoolreportheader', compact('schoolreport', 'id'));
    }
    ...
    public function newschoolreport($id)
    {
        ...
        if ($beneficialLevel == 'TERTIARY') {
            return view('committee.tertiaryschoolreportheadernew', compact('id'));
        } elseif ($beneficialLevel == 'THEOLOGY') {
            return view('committee.tertiaryschoolreportheadernew', compact('id'));
        } elseif ($beneficialLevel == 'SPECIAL') {
            return view('committee.tertiaryschoolreportheadernew', compact('id'));
        } else {
            return view('committee.schoolreportheadernew', compact('id'));
        }
    }
    ...
    public function viewschoolreport($id)
    {
        ...
        return view('committee.schoolreportheaderview', compact('reporthead', 'reportlist'));
    }
    ...
    public function additionalinfo($id)
    {
        ...
        return view('committee.additionalinfo.index', compact('id', 'commData', 'schoolData', 'transferData'));
    }
    ...
    {
        return view('committee.additionalinfo.newschoolinfoform', compact('id'));
    }

    public function getschoolinfo($id)
    {
        $schrec = SchoolInfo::where('id', $id)->first();
        return view('committee.additionalinfo.editschoolinfoform', compact('schrec'));
    }
    ...
    public function newtransfer($id)
    {
        ...
        return view('committee.additionalinfo.newtransfer', compact('id', 'schoolList'));
    }
    ...
    public function gettransfer($id)
    {
        ...
        return view('committee.additionalinfo.edittransfer', compact('schrec', 'id'));
    }
